...
const Player = ({ player, index, handleDeletePlayer }) => {
    return (
        <div className='flex flex-col gap-4 border-b-2'> 
            <div className='flex flex-row text-xl items-center'>
                <p className='w-[222px]'>Số thứ tự cầu thủ</p>
                <input type='text' className=' bg-stone-200 w-1/3 pl-4' value={player.number} />
            ...
            <div className='flex flex-row text-xl justify-between'>
                ...
                <input type='text' className=' bg-stone-200 w-5/6 pl-4'value={player.name} />
            </div>
            <div className='flex flex-row text-xl'>
                <p className='w-[222px]'>Loại cầu thủ</p>
                <select name="playerType" className='bg-stone-200 w-64 pl-4' value={player.type}>
            ...
            <div className='flex flex-row text-xl justify-between'>
                ...
                <input type='text' className=' bg-stone-200 w-5/6 pl-4'value={player.birthday} />
            </div>
            <div className='flex flex-row text-xl justify-between pb-8'>
                <p className='w-64'>Ghi chú</p>
                <input type='text' className=' bg-stone-200 w-5/6 pl-4' value={player.note}/>
            </div>
        </div>
    )
}
